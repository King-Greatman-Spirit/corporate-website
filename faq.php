...
<!-- Mirrored from html.rometheme.pro/housedeco/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jul 2024 09:47:11 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-lg-3">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="project_detail.html">PROJECT DETAIL</a>
                                    </li>
        ...
        <section class="section">
            <div class="r-container">
                <div class="row row-cols-1 row-cols-lg-2">
                    <div class="col mb-3">
                        <img src="image/image-600x400-15.png" alt="" class="img-fluid">
                    </div>
                    <div class="col mb-3">
                            ...
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <div class="accordion-item border">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button fw-bold accent-color" type="button"
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <p class="text-gray">
                                                Sed vel eleifend neque, ac mattis ligula. Fusce at tellus nec erat
                                                pretium maximus eu et eros. Mauris ligula ex, egestas non condimentum
                                                ut, rutrum eget massa.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item border">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button fw-bold accent-color collapsed" type="button"
                                    ...
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p class="text-gray">
                                                ...
                                                pellentesque libero a porttitor.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item border">
                                    ...
                                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p class="text-gray">
                                                Suspendisse vestibulum mi lacus, ut sagittis augue placerat aliquam.
                                                Maecenas velit ex, posuere ut ullamcorper vel, pharetra eu felis.
                                                Quisque tellus dolor, vestibulum at erat gravida, aliquam ultrices dui.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item border">
                                    ...
                                    <div id="flush-collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p class="text-gray">
                                                Mauris ligula ex, egestas non condimentum ut, rutrum eget massa. Aliquam
                                                erat volutpat. Praesent fringilla egestas justo.
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="r-container">
                <div class="row row-cols-1 row-cols-lg-2 text-center text-lg-start">
                    <div class="col col-lg-7">
                        <h4 class="text-white">NEED TO REDESIGN YOUR LIVING SPACE ? HIRE US NOW</h4>
                    </div>
                    <div class="col col-lg-5">
                        <div class="d-flex justify-content-center justify-content-lg-start">
                            <a href="contact.html" type="button"
                                class="btn btn-accent-light font-1 fw-semibold rounded-0">CONTACT US</a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from html.rometheme.pro/housedeco/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jul 2024 09:47:12 GMT -->
</html>